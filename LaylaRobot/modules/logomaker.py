...
async def lego(event):
 ...
 try:
    ...
    fname2 = "LogoByRoso.png"
    img.save(fname2, "png")
    await tbot.send_file(event.chat_id, fname2, caption="Made By *Roso*")
    if os.path.exists(fname2):
            os.remove(fname2)
 except Exception as e:
   await event.reply(f'Error..try again later, {e}')
...
async def lego(event):
 ...
 try:
    ...
    fname2 = "LogoByRoso.png"
    img.save(fname2, "png")
    await tbot.send_file(event.chat_id, fname2, caption="Made By @RosoManage2_bot")
    if os.path.exists(fname2):
            os.remove(fname2)
 except Exception as e:
   await event.reply(f'Error..try again later, {e}')
